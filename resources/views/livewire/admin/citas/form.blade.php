...
<div style="max-width:820px;margin:0 auto;padding:24px 16px;">
  ...
  <form wire:submit.prevent="save" class="card" style="padding:16px;">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
      <div>
        <label style="display:block;margin-bottom:.25rem;">Usuario</label>
      ...
      <div>
        <label style="display:block;margin-bottom:.25rem;">Proyecto</label>
      ...
      <div>
        <label style="display:block;margin-bottom:.25rem;">Fecha</label>
      ...
      <div>
        <label style="display:block;margin-bottom:.25rem;">Hora</label>
      ...
      <div>
        <label style="display:block;margin-bottom:.25rem;">Estado</label>
      ...
      <div>
        <label style="display:block;margin-bottom:.25rem;">Teléfono contacto</label>
        <input type="text" wire:model.defer="telefono_contacto" style="width:100%;border:1px solid #d1d5db;border-radius:10px;padding:.5rem .75rem;">
        @error('telefono_contacto')<div style="color:#be123c;font-size:.85rem;margin-top:.25rem;">{{ $message }}</div>@enderror
      </div>

      <div style="grid-column:1/-1;">
        <label style="display:block;margin-bottom:.25rem;">Notas</label>
